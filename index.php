...
.top-seller-grid {
        ...
        align-items: center;
        gap: 15px;
        flex-wrap: wrap; /* Ensures they don't break into multiple rows */
    }

    .seller-card {
        width: calc(100% / 7 - 15px); /* Distribute equally */
        display: flex;
    ...
    .author-avatar img {
        width: 80px; /* Ensure all avatars are the same size */
        height: 80px;
        border-radius: 50%;
        object-fit: cover;
    }
                                    ...
                                    <div class="wrap-heading flat-slider flex">
                                        <div class="content">
                                            ...
                                            <div class="flat-bt-slider flex style2">
                                                <a href="explore.php" class="sc-button header-slider style style-1 rocket fl-button pri-1"><span>Explore
                                                </span></a>
                                                <a href="create-item.php" class="sc-button header-slider style style-1 note fl-button pri-1"><span>Create
                                                </span></a>
                                            </div>
                                        </div>
                                        <div class="image">
    <img class="img-bg" src="assets/images/backgroup-secsion/img-bg-sliderhome2.png" alt="Background Image">
    <img src="assets/images/box-item/imgslider2.png" alt="NFT Image">
</div>
                                    </div>
                                ...
                                <div class="themesflat-container ">
                                    <div class="wrap-heading flat-slider flex">
                                        <div class="content">
                                            ...
                                            <h1 class="heading"><span class="tf-text s1">Sell extraordinary</span>                                          
                                            </h1>
                                            <h1 class="heading">Monster NFTs</h1>
                                            <p class="sub-heading mg-t-29 mg-bt-44">Marketplace for monster character cllections non fungible token NFTs
                                            </p>
                                        ...
                                        <div class="image">
                                            <img class="img-bg" src="assets/images/backgroup-secsion/img-bg-sliderhome2.png" alt="Image">
    ...
    <div class="themesflat-container">
        <div class="row">
            ...
            <?php 
            // Fetch 4 random NFTs where status = 1
            $select = mysqli_query($con, "SELECT * FROM usermint WHERE status = '1' ORDER BY RAND() LIMIT 4");
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="sc-card-product">
                    <div class="card-media">
                        <a href="usernftdetails.php?usernft=<?php echo $id ?>">
                            <img src="./pimage/<?php echo $row['nft_image']; ?>" alt="NFT Image" class="img-fluid">
                        </a>
                    ...
                    <div class="meta-info">
                        <div class="author">
                            ...
                            <div class="info">
                                <span>Owned By</span>
                                <h6><a href="author02.html"><?php echo $row['username']; ?></a></h6>
                            </div>
                        </div>
                        <div class="price">
                            <span>Current Bid <b><?php echo $row['bids']; ?></b></span>
                            <h5><?php echo $row['price']; ?> ETH</h5>
                        </div>
                    </div>
                    <div class="card-bottom">
                        <a href="usernftdetails.php?usernft=<?php echo $id ?>" class="sc-button style bag fl-button pri-3">
                            <span>Place Bid</span>
                        </a>
                    </div>
                </div>
            ...
            <?php 
                ...
                echo "<p class='col-12 text-center'>No NFTs available for auction.</p>";
            }
            ?>
        </div>
    </div>
...
<section class="tf-section live-auctions style2 no-pt-mb tl-pb-0">
    <div class="themesflat-container">
        <div class="row">
            <div class="col-md-12">
                <div class="heading-live-auctions">
                    <h2 class="tf-title">Top Sellers</h2>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="top-seller-grid">
                    ...
                    // Predefined avatars
                    $avatars = [
                        "assets/images/avatar/avt-1.jpg",
                        "assets/images/avatar/avt-2.jpg",
                        "assets/images/avatar/avt-3.jpg",
                        "assets/images/avatar/avt-4.jpg",
                        "assets/images/avatar/avt-5.jpg",
                        "assets/images/avatar/avt-6.jpg",
                        "assets/images/avatar/avt-7.jpg",
                        "assets/images/avatar/avt-8.jpg",
                        "assets/images/avatar/avt-9.jpg"
                    ];

                    // Fetch 7 random users
                    $result = mysqli_query($con, "SELECT fullname FROM user ORDER BY RAND() LIMIT 7");
                        ...
                        <div class="seller-card">
                            <div class="sc-author-box style-2">
                                <div class="author-avatar">
                                    <img src="<?php echo $random_avatar; ?>" alt="Avatar" class="avatar">
                                    <div class="badge"></div>
                                </div>
                                <div class="author-infor">
                                    <h5><a href="author02.html"><?php echo $fullname; ?></a></h5>
                ...
                <div class="themesflat-container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                         ...
                         <?php 
                             $select = mysqli_query($con, "SELECT * FROM   usermint WHERE status = '1'");
                                  if (mysqli_num_rows($select) > 0) {
                                    while ($row = mysqli_fetch_assoc($select)) {
                                      $id = $row ['id'];
                                      $userid = $row ['userid'];
                        ...
                        <div class="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            <div class="sc-card-product">
                                <div class="card-media">
                                    <a href="usernftdetails.php?usernft=<?php echo $id ?>"><img height="80" width="80" src="./pimage/<?php echo $row['nft_image']  ?>" style="width: 414px; height: 380px; "></a>
                                ...
                                <div class="card-bottom">
                                    <a href="usernftdetails.php?usernft=<?php echo $id ?>" class="sc-button style bag fl-button pri-3" ><span>Place Bid</span></a>
                                </div>
                            </div>
                        </div>
