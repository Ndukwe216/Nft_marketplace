                                ...
                                <div class="wrap-box flex">
                                    ...
                                    <nav id="main-nav" class="main-nav">
                                        <ul id="menu-primary-menu" class="menu">
                                            ...
                                            <li class="menu-item">
                                                <a href="mynft.php">MyNFT</a>
                                               
                                            </li>
                                            
                                            <li class="menu-item">
                                                 <a href="create-item.php" >Create</a>
                                            </li>

                                              <li class="menu-item  ">
                                                <a href="mybids.php">MyBids</a>
                                ...
                                <?php } ?>
                                    ...
                                    <div class="flat-search-btn flex">
                                        ...
                                        <div class="sc-btn-top mg-r-12" id="site-header">
                                            <a  href="connect-wallet.php" id="connectbtn" class="sc-button header-slider style style-1 wallet fl-button pri-1"><span>Wallet connect
                                            </span></a>
                                            ...
                                            <div class="header_avatar">
                                                ...
                                                <div class="popup-user">
                                                    ...
                                                    <div class="avatar_popup mt-20">
                                                        ...
                                                        <?php 
                                                                 $select = mysqli_query($con, "SELECT * FROM user WHERE id = '$userid'");
                                                    ...
                                                    <?php } ?>
                                                        ...
                                                        <div class="d-flex align-items-center mt-20 mg-bt-12">
                                                            <div class="info">
                                                                 <p class="btn btn btn-primary"><a href="addfunds.php">Add funds</a></p>

                                                                <p class="btn btn btn-info"> <a href="withdrawl.php">Withdrawal</a></p><br><br>
                                                                <p class="btn btn btn-primary"> <a href="transfer.php">Transfer</a></p>
                                                                <br> <br>
                                                                <p>Balance</p>
                                                                <?php
                                                                    $select = mysqli_query($con, "SELECT * FROM user WHERE id = '$userid'");
                                                                ...
                                                                <p class="style"><?php echo $amount  ?> ETH</p>
                                                            </div>
                                                        ...
                                                        <div class="links mt-20">
                                                           ...
                                                           <?php 
                                                            ...
                                                            <a class="mt-10" href="logout.php" id="logout">
                                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
